...
function formatID($a, $char, $lenght, $table, $column){
    ...
    // "G" = Pengirim/Gudang, "" = Merk dan Barang, "KTG" = Kategori
    // if($a == "G" or $a = "" or $a = "KTG" or $a = "W"){
    ...
    //     $newCode = 1;
    // } else {
    //     $newCode = (int)str_replace($formattedText, "", $data[0][$column]) + 1;
    // }
    
    // $newCode = sprintf("%0".($lenght - strlen($formattedText))."d", $newCode);
    

    // return $formattedText.$newCode;

}
 
// Merk
// var_dump("Kategori = ".formatID("KTG", "", 6));
// var_dump(formatID("", "cirebon", 6, "MERK", "ID_MERK"));
// var_dump("Barang = ".formatID("", "FLADEO", 6));
// var_dump("Pencatatan = ".formatID("F", "070822", 10));
// var_dump("Faktur = ".formatID("C", "070822", 10));
// var_dump("Pengirim = ".formatID("G", "SURABAYA", 7));
// $dataKota = getData("SELECT NAMA_KOTA FROM 'KOTA/KAB'");
// // var_dump($dataKota);
// $kota = [];
// foreach ($dataKota as $kot) {
//     $kota[] = formatID('G', $kot['NAMA_KOTA'], 6)."\n";
// }
// sort($kota);
// var_dump($kota);
// echo formatID('', 'NGANJUK', 6);
